#ifndef CONTAINER_ESP32_INKPLATE_H
#define CONTAINER_ESP32_INKPLATE_H
#include "litehtml.h"
#include "Inkplate.h"

//inherit from document container
//class container_esp32_inkplate : public litehtml::document_container
class container_esp32_inkplate
{
  public:
    container_esp32_inkplate(Inkplate *d1);
    virtual ~container_esp32_inkplate(void);

    //MUST implement for document_container https://github.com/litehtml/litehtml/wiki/document_container
